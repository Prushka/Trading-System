...
// Glitch List: Trade ID 0 works even when this com.phase2.trade.trade, pressing exit immediately exists program, normal to keep removing personalUser.csv?
public class TradeController {
    ...
    /**
     * Takes requests from a com.phase2.trade.user and turns it into information that can be used by TradeManager
    ...
    /**
     * Creates a new com.phase2.trade.trade
     * @param request All the com.phase2.trade.user's input
     * @return A description of the success of the creation of the com.phase2.trade.trade
     */
    ...
    /**
     * Edits the date and time of a com.phase2.trade.trade
     * @param request All the com.phase2.trade.user's input
    ...
    /**
     * Edits the location of a com.phase2.trade.trade
     * @param request All the com.phase2.trade.user's input
    ...
    /**
     * Confirms that a com.phase2.trade.trade will occur
     * @param request All the com.phase2.trade.user's input
    ...
    /**
     * Confirms the a com.phase2.trade.trade has happened
     * @param request All the com.phase2.trade.user's input
     * @return A description of the state of confirmation
     */
    ...
    /**
     * @param input The com.phase2.trade.user's input
    ...
    /**
     * @param input The com.phase2.trade.user's input
     * @return True iff the input is correct com.phase2.com.phase2.trade.trade.item input
     */
    ...
    /**
     * @param request The com.phase2.trade.user's input
    ...
    /**
     * @param request The com.phase2.trade.user's input
     * @return A description of all the com.phase2.trade.user's created trades (including second meetings)
     */
     ...
     * @return The com.phase2.trade.user IDs and frequency of trading with this com.phase2.trade.user
     */
